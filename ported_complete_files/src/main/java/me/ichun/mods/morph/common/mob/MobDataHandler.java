...
public class MobDataHandler
{
    ...
    private static boolean readMobDataJson(String json) throws JsonSyntaxException, IllegalStateException
    {
        ...
        if(jsonObject.has("forEntity"))
        {
            ...
            try
            {
                if(ForgeRegistries.ENTITY_TYPES.containsKey(rl)) //this entity type is registered, load it up
                {
    ...
    {
        return getMobData(ForgeRegistries.ENTITY_TYPES.getKey(living.getType()));
    }
}
