...
public class StepHeightTrait extends Trait<StepHeightTrait>
{
    ...
    {
        player.setMaxUpStep(0.6F); //return to default, next trait will handle it... hopefully.
    }
    ...
    {
        player.setMaxUpStep((float) amount); //Step heights below the default of 0.6 are allowed
    }
