...
public class ElementBiomassUpgrades extends ElementFertile<WindowBiomassUpgrades.ViewBiomassUpgrades>
{
    ...
    public void init()
    {
        ...
        if(!hasInit)
        {
            ...
            {
                theParent.setPos((getBbWidth() - ElementUpgradeNode.SIZE) / 2, (getBbHeight() - ElementUpgradeNode.SIZE) / 2);
    ...
    @Override
    public void render(PoseStack stack, int mouseX, int mouseY, float partialTick) //TODO play upgrade sound?
    {
