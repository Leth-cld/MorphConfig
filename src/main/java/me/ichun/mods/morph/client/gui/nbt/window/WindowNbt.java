...
public class WindowNbt extends Window<WorkspaceNbt>
{
    ...
    public static class ViewNbt extends View<WindowNbt>
    {
        ...
        {
            for(Map.Entry<String, Tag> e : tag.getAllKeys().stream().map(k -> Map.entry(k, tag.get(k))).toList())
            {
                ...
                if(e.getValue() instanceof CompoundTag)
                {
                    ...
                    addModifierInfo(babyMods, ((CompoundTag)e.getValue()), list, info, depth + 1);
                }
            }
        }
        ...
        public LivingEntity compileAndApply()
        {
            ...
            if(variant != null)
            {
                return variant.createEntityInstance(Minecraft.getInstance().player.level(), (Player)null);
            }
        ...
        public boolean export()
        {
            ...
            try
            {
                ...
                ResourceLocation rl = ForgeRegistries.ENTITY_TYPES.getKey(rendModEnt.entToRender.getType());
        ...
        public static class ModifierInfo
        {
            ...
            public ModifierInfo(ModifierInfo parent, String key, Tag inbt, Info info)
            {
                this.parent = parent;
